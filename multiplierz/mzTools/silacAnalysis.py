...
def interpolatePoints(firstPoints, secondPoints):
    ...
    firstScans = list(zip(*firstPoints))[1]
    secondScans = list(zip(*secondPoints))[1]
    
    onlyFirstScans = set(firstScans) - set(secondScans)
    onlySecondScans = set(secondScans) - set(firstScans)
    
    firstMZ = median(list(zip(*firstPoints))[0])
    secondMZ = median(list(zip(*secondPoints))[0])
    firstChg = median(list(zip(*firstPoints))[2])
    secondChg = median(list(zip(*secondPoints))[2])
...
def interpolateTriplePoints(firstPoints, secondPoints, thirdPoints):
    firstScans = list(zip(*firstPoints))[1]
    secondScans = list(zip(*secondPoints))[1]
    thirdScans = list(zip(*thirdPoints))[1]
    
    firstMZ = median(list(zip(*firstPoints))[0])
    secondMZ = median(list(zip(*secondPoints))[0])
    thirdMZ = median(list(zip(*thirdPoints))[0])
    firstChg = median(list(zip(*firstPoints))[2])
    secondChg = median(list(zip(*secondPoints))[2])
    thirdChg = median(list(zip(*thirdPoints))[2])
